            ...
            <div className="flex-1 min-h-0 overflow-auto p-4">
              {canRender && doc ? (
                ...
                >
                  <div
                    className={cn(
                      'rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-w-0 overflow-x-auto shadow-sm transition-[width] duration-200 ease-out',
